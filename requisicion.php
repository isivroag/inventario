...
if ($resultado->rowCount() >= 1) {
    ...
    $fecha = date('Y-m-d');
    $consultatmp = "INSERT INTO tmp_req (tokenid,estado_req,fecha_req) VALUES('$tokenid','1','$fecha')";
    $resultadotmp = $conexion->prepare($consultatmp);
    $resultadotmp->execute();

    $consultatmp = "SELECT folio_req FROM tmp_req WHERE tokenid='$tokenid' and estado_pres=1 ORDER BY folio_req DESC LIMIT 1";
    $resultadotmp = $conexion->prepare($consultatmp);
    $resultadotmp->execute();
...
$consultacon = "SELECT * FROM producto WHERE estado_concepto=1 ORDER BY id_concepto";
...
$consultadet = "SELECT * FROM vdetalle_req WHERE folio_req='$folio' ORDER BY id_reg";
                                ...
                                <div class=" row justify-content-sm-center">
                                    <div class="col-sm-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="fraccionamiento" id="fraccionamiento"><?php echo $fraccionamiento; ?></input>
                                        </div>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td><?php echo $datdet['nom_producto'] ?></td>
